...
function showResults(quizID) {
  ...
  if (activeQuiz.checkAnswers()) {
    ...
    if (quizScorePercent >= 75)
      ...
      quizResultElement.style.backgroundColor = "#967100";
    else if (quizScorePercent >= 25)
      quizResultElement.style.backgroundColor = "#AC6600";
    else if (quizScorePercent >= 0)
      quizResultElement.style.backgroundColor = "#E91C0D";
...
window.onload = function () {
  ...
  quizzes["chap1-ativ1-ex1"] = new Quiz("chap1-ativ1-ex1", ["a","b","1/3"]);

  quizzes["chap1-ativ2-ex1"] = new Quiz("chap1-ativ2-ex1", ["a","a","a","a","c"]);

  quizzes["chap1-ativ6-ex1"] = new Quiz("chap1-ativ6-ex1", [["a","c","e","h","j"]]);

  quizzes["chap1-ativ10-ex1"] = new Quiz("chap1-ativ10-ex1", [["a","b","d","e","f","h","i","k","l"]]);

  quizzes["chap1-ativ11-ex1"] = new Quiz("chap1-ativ11-ex1", ["c","d","g","i","1/6","1/8","1/10","1/2","a","a","a","b","a"]);

  quizzes["chap1-ativ12-ex1"] = new Quiz("chap1-ativ12-ex1", ["G","D","I","B","A","F"]);

  quizzes["chap1-ativ13-ex1"] = new Quiz("chap1-ativ13-ex1", ["a","b","c","c","c","a","c","b","c","b","c","a"]);
